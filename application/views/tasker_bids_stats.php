                                        ...
                                        foreach ($all_bids as $category) { ?>
                                            <tr>
                                                ...
                                                <td style="width: 15%;">
                                                 ...
                                                 -->
                                                      <?php }elseif($category->bid_status == 4){?>
                                                        ...
                                                        <a href="#" class="commet" data-uid="u<?= $category->user_details_id ?>" >
                                                        <button style="background-color: #3acc42;border-radius:2px solid #3acc42;margin: 5px 0px;width: 100%;"type="button" class="btn btn-info">Open Chat</button>
                                                        </a>

                                                      <?php }elseif($category->bid_status==2){ ?>
                                                ...
                                                <td>
                                                        ...
                                                        <a href="<?= base_url() ?>view_proposal_details?all_bids_id=<?= $category->all_bids_id ?>">
                                                            <img style="width: 100%;" src="<?php echo base_url() . "uploads/" . $category->project_ss; ?>" alt="">
                                                        </a>
                                                        </div>
