...
<body>
    <div class="container" style="max-width: 600px;">
        ...
        <div class="row justify-content-center align-items-center" id="login">
            ...
            <div class="container">
                <h3 class="text-center text-black pt-3" style="font-family: 'Playfair Display', serif;"> <b> Login Form</b></h3>
            </div>
            ...
            <div class="col-12">
                <form class="form-group" id="form1" name="registration" action="<?= base_url() ?>check-login" method="POST">
                    ...
                    <div class="col-12" style="text-align: center;">
                        ...
                        <!-- <a href="#" id="reset" class="btn btn-danger"></a> -->
                    </div>
                </form>
