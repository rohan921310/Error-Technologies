...
#default parameters
$clientId = 'CF62564C1Q6RQR65J9LKFHDCR7G';
$clientSecret = 'cc283a563f274aa8a65cd686159287ff08227f19';
$env = 'test';
...
$beneficiary = array(
    'beneId' => $history->user_details_id,
    'name' => $history->user_name,
    'email' => $history->user_email,
    'phone' => $history->user_number,
    'bankAccount' => $history->user_bank,
    'ifsc' => $history->user_ifsc,
    'address1' => $history->user_address,
    'city' => $history->user_city,
    'state' => $history->user_state,
    'pincode' => $history->user_pincode,
);
$transfer = array(
    'beneId' => $history->user_details_id,
    'amount' => $history->req_wallet_amount,
    'transferId' => $history->payments_history_id,
);
