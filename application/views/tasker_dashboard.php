                        ...
                        <div class="row mb-0">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div><span>New Completed Tasks</span>
                                        <h3 class="font-medium mb-0"><?php
                                                                        $j = 0;
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div><span>Payout</span>
                                        <h3 class="font-medium mb-0"><?= $this->session->userdata('payouts') ?></h3>
                                    </div>
                                </div>
                            </div>
                            <!-- col -->
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-md-flex align-items-center">
                            <div>
                                <h4 class="card-title">New Completed Tasks</h4>
                            ...
                            <table class="table no-wrap v-middle">
                                <thead>
                                    <tr class="border-0">
                                        ...
                                        <th class="border-0">Tasker Name</th>
